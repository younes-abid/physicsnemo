...
CONFIG_NAME="config_training_custom_regression_normal_U10_V10"
CHECKPOINT_PATH="/app/checkpoints_regression/U10_V10/"
LOGS_PATH="/app/outputs/logs/regression/U10_V10/"
